...
Saturn.prototype.createGeometry = function() {
    var geometry = new THREE.SphereGeometry(this.sunRadius / this.SunRadiusRatio * 9.26, 128, 128);
    return geometry;
};


Saturn.prototype.addOrbit = function(amplitude) {
...
Saturn.prototype.createRing = function() {
    ...
    var geometry = new THREEx.Planets._RingGeometry(this.sunRadius / this.SunRadiusRatio * 9.26, 0.75, 64);
    var material = new THREE.MeshPhongMaterial({
...
Saturn.prototype.updatePhysics = function() {
    ...
    //this.saturn.position.y = 9.529 * this.AU * Math.sin(Date.now() / 10000);
